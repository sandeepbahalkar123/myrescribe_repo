...
public class MyRescribeConstants {
    ...
    public static final String TASK_LOGIN_WITH_PASSWORD = MyRescribeConstants.BLANK + 22;
    public static final String TASK_LOGIN_WITH_OTP = MyRescribeConstants.BLANK + 23;
