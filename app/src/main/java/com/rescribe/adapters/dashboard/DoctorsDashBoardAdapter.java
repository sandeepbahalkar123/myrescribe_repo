...
public class DoctorsDashBoardAdapter extends RecyclerView.Adapter<DoctorsDashBoardAdapter.ListViewHolder> {
    ...
    public DoctorsDashBoardAdapter(Context mContext, ArrayList<ReviewList> dataList) {
    ...
    @Override
    public DoctorsDashBoardAdapter.ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_doctor_reviews_layout, parent, false);

        return new DoctorsDashBoardAdapter.ListViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(DoctorsDashBoardAdapter.ListViewHolder holder, int position) {
