...
public class SingleVisitDetailHelper implements ConnectionListener {
    ...
    public void doGetOneDayVisit(String opdId, String doctorId) {
        ...
        mConnectionFactory.setUrl(Config.ONE_DAY_VISIT_URL + opdId + "&docId=" + doctorId + "&patientId=" + RescribePreferencesManager.getString(RescribePreferencesManager.PREFERENCES_KEY.PATIENT_ID, mContext) + "&appName=patient");
