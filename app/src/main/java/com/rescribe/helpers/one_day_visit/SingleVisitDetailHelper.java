...
public class SingleVisitDetailHelper implements ConnectionListener {
    ...
    public void doGetOneDayVisit(String opdId) {
        ...
        mConnectionFactory.setUrl(Config.ONE_DAY_VISIT_URL+opdId+mContext.getString(R.string.and_sign)+ RescribeConstants.PATIENT_ID+ RescribePreferencesManager.getString(RescribePreferencesManager.MYRESCRIBE_PREFERENCES_KEY.PATIENT_ID,mContext));
