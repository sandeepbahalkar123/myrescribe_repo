...
import com.philliphsu.bottomsheetpickers.customui.CustomViewPager;
import com.philliphsu.bottomsheetpickers.customui.SwipeDirection;
...
class PagingDayPickerView extends LinearLayout implements OnDateChangedListener, OnPageChangeListener, OnMonthClickListener {
    ...
    private boolean isOutOfRangeInvisible;
    ...
    private DateRangeHelper mDatePickerController;
    ...
    public void setController(DatePickerController controller) {
        ...
        refreshAdapter();
        onDateChanged();
        mDatePickerController = mMonthPickerView.setDatePickerController(mController);
    }
    ...
    private void init(Context context) {
        ...
        mViewPager = (CustomViewPager) findViewById(R.id.bsp_viewpager);
