...
public class UnreadNotificationAlertAdapter extends RecyclerView.Adapter<UnreadNotificationAlertAdapter.FileViewHolder> {
    ...
    public UnreadNotificationAlertAdapter(Context context, ArrayList<UnreadSavedNotificationMessageData> list, OnNotificationItemClicked listener) {
    ...
    public FileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new UnreadNotificationAlertAdapter.FileViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final UnreadNotificationAlertAdapter.FileViewHolder holder, final int position) {
