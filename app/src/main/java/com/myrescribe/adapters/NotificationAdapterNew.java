...
public class NotificationAdapterNew extends RecyclerView.Adapter<NotificationAdapterNew.ListViewHolder> implements HelperResponse {

    private static final String DINNER = "dinner";
    private static final String LUNCH = "lunch";
    private static final String BREAK_FAST = "breakfast";
    private static final String SNACKS = "snacks";
    private static final String TAG = "NotificationAdapterNew";
    ...
    private NotificationAdapterNew.OnHeaderClickListener onHeaderClickListener;
    List<SlotModel> medicationList = null;
    private Integer medicineID = null;
    private SlotModel slotModel = null;


    public NotificationAdapterNew(Context context, List<AdapterNotificationModel> dataSet, String time[]) {
       ...
       /* for(int i = 0;i<mDataSet.size();i++){
        ...
        try {
            this.onHeaderClickListener = ((NotificationAdapterNew.OnHeaderClickListener) mContext);
    ...
    @Override
    public NotificationAdapterNew.ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.notification_list_item, parent, false);
        return new NotificationAdapterNew.ListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final NotificationAdapterNew.ListViewHolder holder, final int position) {
